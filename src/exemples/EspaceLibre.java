...
/**
 * Exemple pour illustrer l'utilisation de l'espace libre avec GridBagLayout.
 */
public class EspaceLibre extends JFrame {
	...
	public EspaceLibre() {
		...
		// On définit la politique de remplissage
		gbc.fill = GridBagConstraints.BOTH; // On remplit toute la case pour mieux visualiser les résultats
		
		/*
		 * Schéma recherché (poids) :
		 * 
		 *         0   1   2   <-- weightx
		 *       +---+---+---+
		 *    1  |   |   |   |
